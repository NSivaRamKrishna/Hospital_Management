	 ...
	 public String verifyCredentials(LoginPojo lp) {
	      ...
	      // System.out.println("password"+password);
	       ...
	       System.out.println(role);
	        ...
	        {
	        	//System.out.println(role);
	        	String query = "SELECT * FROM registration WHERE email = ? AND password = ? AND role='doctor' " ;
	        	...
	        	String query = "SELECT * FROM registration WHERE email = ? AND password = ? AND role='patient'" ;
